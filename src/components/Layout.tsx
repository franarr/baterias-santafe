        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-white/50">
              <li><a href="#productos" className="hover:text-white transition-colors">Baterías para Autos</a></li>
              <li><a href="#productos" className="hover:text-white transition-colors">Baterías para Motos</a></li>
              <li><a href="#productos" className="hover:text-white transition-colors">Baterías para Camiones</a></li>
              <li><a href="#productos" className="hover:text-white transition-colors">Baterías Start-Stop EFB</a></li>
