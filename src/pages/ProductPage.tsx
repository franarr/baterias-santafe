...
export function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0c1322] pt-24 pb-32 md:pb-12">
      {/* SEO: Dynamic title */}
      <title>{product.title} | Baterías Santa Fe</title>
      ...
      <div className="max-w-[1280px] mx-auto px-5 mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#111827] rounded-2xl border border-white/5 p-6 md:p-8"
          >
